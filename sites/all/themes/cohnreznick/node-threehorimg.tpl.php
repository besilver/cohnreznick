        ...
        <div class="left"> 
        	<?php if($node->field_limage) : ?>		 	
		       	    <?php if(getNodeFieldValue($node, 'field_llink')) : ?>
		       	        <a href="<?php echo url(getNodeFieldValue($node, 'field_llink')) ?>"><?php echo getNodeImage($node, 'field_limage', array('width'=>127)) ?></a>
		       	    <?php else : ?>
		       	    	<?php echo getNodeImage($node, 'field_limage', array('width' => 127)) ?>
		       	    <?php endif; ?>
		    <?php endif; ?>
        ...
        <div class="left">
        	<?php if($node->field_cimage) : ?>		 	
		       	    <?php if(getNodeFieldValue($node, 'field_clink')) : ?>
		       	        <a href="<?php echo url(getNodeFieldValue($node, 'field_clink')) ?>"><?php echo getNodeImage($node, 'field_cimage', array('width'=>127)) ?></a>
		       	    <?php else : ?>
		       	    	<?php echo getNodeImage($node, 'field_cimage', array('width' => 127)) ?>
		       	    <?php endif; ?>
		    <?php endif; ?> 
        ...
        <div class="right"> 
        	<?php if($node->field_rimage) : ?>		 	
		       	    <?php if(getNodeFieldValue($node, 'field_rlink')) : ?>
		       	        <a href="<?php echo url(getNodeFieldValue($node, 'field_rlink')) ?>"><?php echo getNodeImage($node, 'field_rimage', array('width' => 127, 'height' => '79')) ?></a>
		       	    <?php else : ?>
		       	    	<?php echo getNodeImage($node, 'field_rimage', array('width' => 127, 'height' => '79')) ?>
		       	    <?php endif; ?>
		    <?php endif; ?> 
